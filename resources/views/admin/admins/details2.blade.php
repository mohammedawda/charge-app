    ...
    <div class="content-body">
        ...
        <div class="card-body pb-0">
            <fieldset class="form-group position-relative mb-0">
                <form class="form form-horizontal striped-rows form-bordered" method="get"  action="{{ route('admin.search', [$admin->id]) }}">
                    <div class="row" style="border-style: dotted;  padding: 25px 50px 75px 75px;">
                        <label class=" label-control col-md-2" for="timesheetinput2">   بداية مدى البحث عن تاريخ </label>


                        <input type="date" id="start" class="form-control col-md-3" name="begin" >
                        <label class=" label-control col-md-2" for="timesheetinput2"> نهاية مدى البحث عن تاريخ </label>

                        <input type="date" id="start" class="form-control col-md-3" name="end" >
                    </div>
<br>
                    <button type="submit" class="btn btn-primary" >

                        <i class="la la-check-square-o"></i> {{ trans("admin.search") }}
                    </button>
                </form>
            </fieldset>
                ...
                <div class="card-head">
                  ...
                  <div class="px-1">
                    <ul class="list-inline list-inline-pipe text-center p-1 border-bottom-grey border-bottom-lighten-3">
                      <li>Registered At :
                        <span class="text-muted">{{$admin->created_at}}</span>
                      </li>
                  ...
                  <div class="project-info-count col-lg-4 col-md-12">
                    ...
                    <div class="project-info-text pt-1">
                      <h5>عدد المحلات المفعلة</h5>
                        ...
                        <div class="project-info-count col-lg-4 col-md-12">
                            <div class="project-info-icon">
                                <h2>{{count($stage_updated)}}</h2>

                            </div>
                            <div class="project-info-text pt-1">
                                <h5>عدد المحلات المعدل عليها</h5>
                            </div>
                        </div>
                </div>
                  <br>
                    ...
                    <div class="project-info-count col-lg-4 col-md-12">
                    <div class="project-info-icon">
                      <h2>{{count($subscriber_created)}}</h2>
                 
                    </div>
                    <div class="project-info-text pt-1">
                      <h5>  اصحاب المحلات المضافة</h5>
                    </div>
                  </div>

                  <div class="project-info-count col-lg-4 col-md-12">
                    <div class="project-info-icon">
                      <h2>{{count($subscriber_active)}}</h2>
                     
                    </div>
                    <div class="project-info-text pt-1">
                      <h5> اصحاب المحلات المفعلة</h5>
                    </div>
                  </div>

                        <div class="project-info-count col-lg-4 col-md-12">
                            <div class="project-info-icon">
                                <h2>{{count($subscriber_updated)}}</h2>

                            </div>
                            <div class="project-info-text pt-1">
                                <h5> اصحاب المحلات المعدل عليها</h5>
                            </div>
                        </div>
                </div>
                <!-- project-info -->
          ...
          <h3 class="page-title text-center">المحلات ({{$admin->stage->count()}})</h3>
          <ul class="timeline">
